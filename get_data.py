...
url = f"https://api.open-meteo.com/v1/forecast?latitude=25.43&longitude=75.64&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Bundi Weather - Past Week')
plt.legend()
...
df.to_csv('data/bundi_weather.csv', index=False)
